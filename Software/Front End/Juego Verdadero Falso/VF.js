const Preguntas = [
    ...
    { pregunta: "SI A LO LARGO DE MI VIDA DONO MUCHAS VECES, VOY A DESARROLLAR ANEMIA", Respuesta: false, Numero: 4 },
    { pregunta: "DESPUES DE DONAR, NO PUEDO HACER NINGUN TIPO DE EJERCICIO", Respuesta: true, Numero: 5 },
    { pregunta: "DESPUÉS DE DONAR UNA VEZ, NO PUEDO DONAR NUNCA MÁS", Respuesta: false, Numero: 6 },
    { pregunta: "UNA UNICA DONACIÓN PUEDE AYUDAR A SALVAR MULTIPLES VIDAS", Respuesta: true, Numero: 7 },
    { pregunta: "GRACIAS A LOS EXAMENES PREVIOS A LA DONACIÓN, SE PUEDE DETECTAR ALGUNA ENFERMEDAD", Respuesta: true, Numero: 8 },
    { pregunta: "LA SANGRE DONADA SE PUEDE DIVIDIR EN COMPONENTES", Respuesta: true, Numero: 9 },
    { pregunta: "CIERTOS TIPOS DE SANGRE SON MÁS NECESITADOS EN LOS HOSPITALES POR SU ESCASEZ", Respuesta: true, Numero: 10 },
