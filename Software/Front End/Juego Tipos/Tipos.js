...
const Preguntas = [
  ...
  {
    pregunta:
      "Martina tiene 20 años y desde que se enteró de los aspectos positivos que tenía donar sangre a los 18 años va a donar una o dos veces por año. La última vez que donó fue hace 8 y un mes después, se hizo un piercing en un estudio profesional. No recuerda si tiene la posibilidad de donar o debe esperar el mismo tiempo que si te harías un tatuaje.",
    Respuesta: true,
    Numero: 7,
  },
  {
